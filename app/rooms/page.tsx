...
export default function RoomsPage() {
  const [ rooms, setRooms ] = React.useState<{id: string, players: string[], host: string, name: string}[]>([]);
  ...
  return (
    <div className="container py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {rooms.map(({id, name, players, host}) => {
          ...
          >
            ...
            <div className="p-4 bg-accent/30 dark:bg-accent/10">
              <p className="text-sm mb-4">Created by Player {host}</p>
